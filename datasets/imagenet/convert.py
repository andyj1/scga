...
parser.add_argument('--in_file', default=f'{DATA_ROOT_DIR}/val224_compressed.pkl', help='input file path')
parser.add_argument('--out_root', default=f'{DATA_ROOT_DIR}', help='output file path')
