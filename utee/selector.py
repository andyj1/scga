...
def dcl_cub(cuda=True, model_root=None):
    from datasets.DCL_finegrained import model, dataset
    # pdb.set_trace()
    cub_1 = model.CUB(model='resnet50')
    cub_2 = model.CUB(model='senet154')
    cub_3 = model.CUB(model='se_resnet101')
...
def dcl_car(cuda=True, model_root=None):
    ...
    car_1 = model.CAR(model='resnet50')
    car_2 = model.CAR(model='senet154')
    car_3 = model.CAR(model='se_resnet101')
...
def dcl_air(cuda=True, model_root=None):
    ...
    air_1 = model.AIR(model='resnet50')
    air_2 = model.AIR(model='senet154')
    air_3 = model.AIR(model='se_resnet101')
