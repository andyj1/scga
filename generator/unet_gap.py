...
def define(input_nc=3, output_nc=3, ngf=128, gen_type='unet', norm='instance',
    ...
    if gen_type == 'unet':
        ...
        network = UnetGenerator(3, 3, 128, 'instance', 'selu')
...
class ResnetGenerator(nn.Module):
    ...
    def forward_features(self, input):
        ...
        # Register hook for layer 15
        hook = self.model0[15].register_forward_hook(hook_fn)
        
        # Forward pass through model0
        _ = self.model0(input)
        
        # Remove hook
        hook.remove()
        
        return features[0]  # Return the captured features from layer 15
...
if __name__ == "__main__":
    ...
    summary(unet_model, (4, 3, 224, 224))
