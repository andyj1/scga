# https://raw.githubusercontent.com/a7med12345/Cycle-GAN-with-Unet-as-GENERATOR/refs/heads/master/MyUnet.py
...
class Unet2(torch.nn.Module):
    def __init__(self,input_channel=3,output_channel=3,change_size=False):
...
if __name__ == '__main__':
    ...
    test_x = Variable(torch.FloatTensor(4, 3, 224, 224))
    out_x = net(test_x)
